package udacity.com.jokerlib;

import java.util.Random;

/** credit to Pyjokes for this exhaustive list :
 * https://github.com/pyjokes/pyjokes/blob/master/pyjokes/jokes_en.py
 */
public class Joker {
    private static String[] jokerVenom = {
    ...
    public static String whySoSerious(){
        return jokerVenom[new Random().nextInt(jokerVenom.length - 1)];
    }
}
